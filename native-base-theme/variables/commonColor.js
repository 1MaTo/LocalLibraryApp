...
export default {
  ...
  // Color
  brandPrimary: platform === PLATFORM.IOS ? theme.first.primary.main : theme.first.primary.main,
  brandInfo: '#62B1F6',
  brandSuccess: '#5cb85c',
  brandDanger: '#d9534f',
  brandWarning: '#f0ad4e',
  ...
  tabBarActiveTextColor: platform === PLATFORM.IOS ? theme.first.text.active : theme.first.text.active,
  tabActiveBgColor: platform === PLATFORM.IOS ? theme.first.secondary.main : theme.first.secondary.main,

  // Header
  toolbarBtnColor: platform === PLATFORM.IOS ? '#007aff' : '#fff',
  toolbarDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : theme.first.primary.toolbarBg,
  ...
  // Spinner
  defaultSpinnerColor: theme.first.primary.main,
